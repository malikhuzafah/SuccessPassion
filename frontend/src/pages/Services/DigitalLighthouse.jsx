  ...
  return (
    <div>
      ...
      <Container>
        ...
        <div>
          <h1 style={{ textAlign: "center" }}>Areas of expertise</h1>
        ...
        <div>
          <h2>Also on successpassion.com</h2>
          <Grid container spacing={2}></Grid>
        </div>
      </Container>
    </div>
...
export default DigitalLighthouse;
